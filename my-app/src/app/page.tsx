...
export default function Home() {
    ...
    return (
        <>
            {/* Suspense wraps the lazy-loaded ScrollHandler */}
                ...
                >
                    ...
                    <div className="flex flex-col text-left space-y-6 md:w-1/2">
                        ...
                        <p className="text-lg text-gray-300 fade-text">
                            ...
                            utvikling av moderne og brukervennlige
                            webapplikasjoner. Jeg interesserer meg for
                            fullstack-utvikling, og trives med å kombinere
                            frontend-design og backend-funksjonalitet for å
                            skape komplette løsninger.
                        </p>
